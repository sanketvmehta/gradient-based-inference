...
#from a_srl.data.dataset_reader.dataset_utils.span_utils import bio_tags_to_conll_format
logger = logging.getLogger(__name__)  # pylint: disable=invalid-name

@Model.register("custom_srl")
class SemanticRoleLabeler(Model):
    ...
    def __init__(self, vocab: Vocabulary,
                 ...
                 decoding_strategy: str = "viterbi") -> None:
    ...
    def forward(self,  # type: ignore
                ...
                metadata: Any = None) -> Dict[str, torch.Tensor]:
        ...
        pos_tags : ``torch.LongTensor``, optional (default = None)
            A torch tensor representing the POS tags for the words in the sentence
            of shape ``(batch_size, num_tokens)``.
        spans : ``torch.LongTensor``, optional (default = None)
    ...
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'SemanticRoleLabeler':
        ...
        decoding_strategy = params.pop("decoding_strategy", "viterbi")
...
def write_to_conll_eval_file(prediction_file: TextIO,
    ...
    if verb_index:
        ...
        verb_only_sentence[verb_index] = sentence[verb_index].__str__()
    ...
    # conll_format_predictions = bio_tags_to_conll_format(prediction)
    # conll_format_gold_labels = bio_tags_to_conll_format(gold_labels)
